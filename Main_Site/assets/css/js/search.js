...
const searchData = {
    resources: [
        ...
        { name: 'Rare Earth Elements', url: 'Main_Site/guides/Resources.html#rare-earth-elements', keywords: ['редкоземельные', 'элементы'] },
        { name: 'Magnetite', url: 'Main_Site/guides/Resources.html#magnetite', keywords: ['магнетит'] },
        { name: 'Robotic Module', url: 'Main_Site/guides/Resources.html#robotic-module', keywords: ['робот', 'модуль'] },
